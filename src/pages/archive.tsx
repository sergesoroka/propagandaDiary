...
import { monthy1, monthy2, commonStatistic } from '../../utils/statisticCalculate'

const archive = () => {
  console.log('STATISTIC: Narrative', commonStatistic("2022-01-01", "2022-01-31", 'Narrative').length  );
  console.log('STATISTIC: Fake', commonStatistic("2022-01-01", "2022-01-31", 'Fake').length  );
  console.log('STATISTIC: Media', commonStatistic("2022-01-01", "2022-01-31", 'Media').length  );
  ...
  return (
    <div className={styles.archivePage}>
      <StatisticDisplay
        mode="disactive"
        month="January"
        narratives={commonStatistic("2022-01-01", "2022-01-31", 'Narrative').length}
      ...
      <StatisticDisplay
        mode="disactive"
        month="February"
        narratives={commonStatistic("2022-02-01", "2022-02-31", 'Narrative').length}
      ...
      <StatisticDisplay
        mode="disactive"
        month="March"
        narratives={commonStatistic("2022-03-01", "2022-03-31", 'Narrative').length}
      ...
      <StatisticDisplay
        mode="disactive"
        month="April"
        narratives={commonStatistic("2022-04-01", "2022-04-31", 'Narrative').length}
      ...
      <StatisticDisplay
        mode="disactive"
        month="May"
        narratives={commonStatistic("2022-05-01", "2022-05-31", 'Narrative').length}
      ...
      <StatisticDisplay
        mode="disactive"
        month="June"
        narratives={commonStatistic("2022-06-01", "2022-06-31", 'Narrative').length}
      ...
      <StatisticDisplay
        mode="disactive"
        month="July"
        narratives={commonStatistic("2022-07-01", "2022-07-31", 'Narrative').length}
      ...
      <StatisticDisplay
        mode="disactive"
        month="August"
        narratives={commonStatistic("2022-08-01", "2022-08-31", 'Narrative').length}
      ...
      <StatisticDisplay
        mode="disactive"
        month="September"
        narratives={commonStatistic("2022-09-01", "2022-09-31", 'Narrative').length}
      ...
      <StatisticDisplay
        mode="disactive"
        month="October"
        narratives={commonStatistic("2022-10-01", "2022-10-31", 'Narrative').length}
      ...
      <StatisticDisplay
        mode="disactive"
        month="November"
        narratives={commonStatistic("2022-11-01", "2022-11-31", 'Narrative').length}
      ...
      <StatisticDisplay
        mode="disactive"
        month="December"
        narratives={commonStatistic("2022-12-01", "2022-12-31", 'Narrative').length}
